...
pub fn kindFromPath(path: []const u8) types.ArtifactKind {
    ...
    const table = .{
        ...
        .{ ".dll", types.ArtifactKind.binary },
        .{ ".so", types.ArtifactKind.binary },
        .{ ".dylib", types.ArtifactKind.binary },
        .{ ".bin", types.ArtifactKind.binary },
        .{ ".o", types.ArtifactKind.binary },
        .{ ".a", types.ArtifactKind.binary },
        .{ ".wasm", types.ArtifactKind.binary },
        .{ ".elf", types.ArtifactKind.binary },
        .{ ".dylib", types.ArtifactKind.binary },
